Scope - Scope is used to define filters that appear at the title bar in list view. Below is an example of Orders scope defined, and appears as a drop-down list of each scope defined.
