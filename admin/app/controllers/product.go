...
// func funcsMap() template.FuncMap { //seems to be similar to named queries in hibernate
...
// 	// for key, value := range inline_edit.FuncMap(i18n.I18n, "en-US", true) { //add all i18 funcs to funcsMap
// 	// 	funcMaps[key] = value
// 	// }
// 	return funcMaps
}
